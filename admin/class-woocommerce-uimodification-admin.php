 ...
 * @subpackage Woocommerce_Uimodification/admin
 */
 ...
 */
class Woocommerce_Uimodification_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/woocommerce-uimodification-admin.css', array(), $this->version, 'all' );
